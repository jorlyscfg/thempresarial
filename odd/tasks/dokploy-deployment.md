...
- DP-006 fix commit: `8f993c7` (`fix(deploy): Install build dependencies in Dokploy image`).
- DP-007 fix commit: `26390ba` (`fix(deploy): Restore Dokploy build output permissions`).
